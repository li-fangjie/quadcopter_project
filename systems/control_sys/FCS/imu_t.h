...
class IMU
{
    ...
    public:
        ...
        float * get_acc_offset_ang();

        int32_t * get_offset_raw();

        void set_sample_rate(uint8_t rate_div);
        
        // 0-7, 260, 184, 94, 44, 21, 10, 5
        void set_DLPF(uint8_t cfg);
        ...
        // V | ACC F | 
        // 0 | 260 Hz
        // void enable_DLPF(uint8_t bandwith);
